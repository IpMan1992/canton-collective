...
const sections=[
 {theme:"summary", title:"CANTON COLLECTIVE — WEEKLY PERFORMANCE  (May 11 – Jun 21, 2026 · GMV = total_sales)", blocks:[
   {subtitle:"SUMMARY — all 6 weeks", headers:["Week","GMV","Orders","AOV","Sessions","Conv Rate","WoW GMV","vs 4-wk Avg","YoY GMV","Verdict"],
   ...
   {subtitle:"Key findings", headers:["#","Finding"], deltaCols:[], verdictCol:-1, rows:[
     ...
     [3,"Conversion stays soft: CVR 0.56→0.44→0.42% over 3 weeks — browse→cart leak, not traffic (sessions flat ~26K)."],
     [4,"AOV slipped off its peak: $108.00 → $106.56 after climbing every week May–early June."],
     [5,"MAMC win is broad (12 SKUs): Lavender Floral hero $847, NEW climber Dusty Rose Bandeau $737, Green Fold Over Skirt $607."],
     ...
     [8,"Blind spot: Meta CC ad account (SGD) UNSETTLED / not queryable."],
     [9,"YoY −37.2% vs Jun 2025 (214 orders @ $97 vs 128 @ $107 now) — June 2025 already scaled."],
   ]},
 ]},
 ...
 {theme:"june", title:"JUNE 2026", blocks:[
   ...
   {subtitle:"Vendor GMV share (% of store)", headers:["Vendor","Jun 1–7","Jun 8–14","Jun 15–21"],
    deltaCols:[], verdictCol:-1, rows:[
     ["1Jinn Studio","31.4%","35.5%","25.7%"],["MAMC","21.5%","22.3%","39.0%"],["2th Desire","20.6%","13.2%","12.4%"],["Deleteex","12.5%","13.8%","11.4%"],
     ["Outtheblue","0.4%","6.6%","0.8%"],["First Floor","4.6%","3.1%","4.0%"],["1Jinn M2M","1.4%","0.4%","1.4%"],["(blank=shipping)","7.1%","4.9%","5.2%"],
   ]},
   {subtitle:"Top products — GMV by week", headers:["Product","Jun 1–7","Jun 8–14","Jun 15–21","Trend"],
    deltaCols:[], verdictCol:-1, rows:[
     ["Lavender Floral Chiffon Slip Mini Dress (MAMC)",1197.35,771.16,847.43,"CLIMBER / hero"],
     ["Dusty Rose Layered Gauze Bandeau Top (MAMC)",0,0,737.11,"NEW CLIMBER"],
     ["Green Fold Over Asymmetric Hem Midi Skirt (MAMC)",326.40,397.63,607.41,"CLIMBER"],
     ["Ruffle Trim Gingham Babydoll Mini Dress (MAMC)",0,432.67,159.80,"Emerging"],
     ["Retro Camisole Layer Top (2th Desire)",693.66,547.90,397.29,"Volatile core"],
     ["Y2K Beaded Multi Strap Top",331.17,594.51,460.85,"Core"],
     ["Outtheblue line (vendor total)",79.00,989.58,109.97,"Spiked then faded"],
     ["Midnight Meow Zip Up Cat Ear Hoodie",530.75,431.75,156.74,"Fading"],
   ]},
   {subtitle:"Email campaigns (Klaviyo)", headers:["Send Date","Campaign","Theme","Recipients","Open Rate","Attributed Rev","Conv"],
    deltaCols:[], verdictCol:-1, rows:[
